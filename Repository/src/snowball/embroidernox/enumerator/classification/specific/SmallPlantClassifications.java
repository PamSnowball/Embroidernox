package snowball.embroidernox.enumerator.classification.specific;
...
public enum SmallPlantClassifications implements IClassifier {
	...
	public int getId() {
		return Integer.parseInt(this.classification.replace("[\\D]", ""));
	}

	@Override
	public String getType() {
		return this.classification.replace("[0-9]", "");
	}
}
