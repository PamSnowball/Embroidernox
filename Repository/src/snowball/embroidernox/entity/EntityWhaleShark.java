...
import snowball.embroidernox.component.Ai;
import snowball.embroidernox.component.Growth;
import snowball.embroidernox.component.Information;
import snowball.embroidernox.component.Life;
import snowball.embroidernox.component.Material;
import snowball.embroidernox.component.Movement;
...
import snowball.embroidernox.enumerator.classification.BaseClassification;
...
import snowball.embroidernox.util.component.Death.FloatDeath;
import snowball.embroidernox.util.component.Environment;
import snowball.embroidernox.util.component.IRequirement;
import snowball.embroidernox.util.requirement.IEnvironment;
import snowball.embroidernox.util.requirement.ReqBiome;
import snowball.embroidernox.util.requirement.ReqTransform;
...
public class EntityWhaleShark extends Entity {
	...
	public EntityWhaleShark() {
		 ...
		 */
		super(2004, "Shark_Whale", BaseClassification.BIG_FISH, 6, -0.5F, true, null, new IconData(1, 2.4F));
		...
		//You can pick colors from snowball.embroidernox.EnumColours enum.
		Vector[] enumColors = { EnumColours.DARK_BLUE.getColour(), EnumColours.DARK_BROWN.getColour(), EnumColours.DARK_GREY.getColour(), 
				EnumColours.DARK_PURPLE.getColour()};
		 ...
		 * The third parameter is an array of vectors with the RGB color informations.
		 * The fourth parameter is an array of prices, it must have a price for each color.
		 */
		this.componentLoader(new Material(this, false, colors, prices));
		 ...
		 */
		this.componentLoader(new Information("Whale Shark", description, 273000, 775, 4, EnumPlaceSound.SPLASH));
		 ...
		 * The sixth parameter is the death type, in this case they float to the surface when die.
		 ...
		 * The third parameter is how many stages your entity has, this parameter is extremely important, cause it will make so the system searches for obj files like:
		 ...
		 * The seventh parameter is a boolean, its true if your entity lay eggs.
